                    ...
                    <div class="flex relative space-x-5 justify-center md:justify-start">
                        ...
                        @foreach($profiles as $profile) 
                            ...
                            <div class="img-wrapper profile-img--xl profile-shadow">
                                <img class="img" src="/storage/{{$profile->profil_photo}}" alt="profile picture">
                            </div>
                            <div>
                                <p><span class="font-bold">{{$profile->name}}<span class="text-graytext font-normal"> &#64;{{$profile->user->username}} ● {{$event->getDate('created_at')}}</p>
                            @endif
                        @endforeach
                            <div class="my-3">
